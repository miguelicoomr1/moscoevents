// Despliega el backend de inscripciones con la cuenta "inscripciones" de
// clasp. La primera vez crea la implementacion y guarda su ID; despues la
// actualiza en el sitio para que la URL /exec no cambie.
const fs = require("fs");
...
console.log(savedId ? `Desplegando en la implementacion ${savedId}...` : "Creando la implementacion del backend de inscripciones...");
...
console.log(`URL del backend: https://script.google.com/macros/s/${deploymentId}/exec`);
